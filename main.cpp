...
int DrawGLScene(GLvoid)                                    // Here's Where We Do All The Drawing
{
	...
	// Calculate the look direction from yaw and pitch
	float lookX = sin(cameraYaw * 3.14159f / 180.0f) * cos(cameraPitch * 3.14159f / 180.0f);
	float lookY = sin(cameraPitch * 3.14159f / 180.0f);
	float lookZ = -cos(cameraYaw * 3.14159f / 180.0f) * cos(cameraPitch * 3.14159f / 180.0f);
