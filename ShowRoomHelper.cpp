...
GLuint ShowRoomHelper::LoadTexture(const char* filename) {
    ...
    if (!image) {
        std::cout << "ShowRoomHelper: Failed to load texture: " << filename << std::endl;
        return 0;
    }
    ...
    std::cout << "ShowRoomHelper: Loaded texture " << filename
...
void ShowRoomHelper::DrawColoredQuad(float x1, float y1, float z1,
    float x2, float y2, float z2,
    float x3, float y3, float z3,
    float x4, float y4, float z4,
...
void ShowRoomHelper::DrawCube(float x, float y, float z,
...
void ShowRoomHelper::DrawWall(float x, float y, float z,
...
void ShowRoomHelper::DrawGrid(float size, int divisions, float y) {
    EnableTexturing(false);
...
void ShowRoomHelper::DrawAxis(float length) {
    EnableTexturing(false);
    glLineWidth(2.0f);
...
void ShowRoomHelper::DrawWireframeRoom(float roomWidth, float roomHeight, float roomDepth) {
    EnableTexturing(false);
...
void ShowRoomHelper::SetColor(float r, float g, float b, float a) {
    glColor4f(r, g, b, a);
}

void ShowRoomHelper::ResetColor() {
